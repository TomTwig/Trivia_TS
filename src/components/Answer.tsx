...
export default function Answer(props: AnswerInterface) {
  return (
    <div className={props.isSelected && !props.isCorrect && props.isGameOver ? "answer red" : "answer"}>
    <div className={!props.isSelected && props.isCorrect && props.isGameOver ? "answer green" : "answer"}>
    <div className={props.isSelected && props.isCorrect && props.isGameOver ? "answer green" : "answer"}>
